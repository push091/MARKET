...
<html lang="en">
	<head>
		...
		<script>
                    ...
                    if (url.indexOf("://") > -1) {
                        var allsps = url.split('/');
                        
                        hostname = allsps[0] + "//" + allsps[2];
                    }
                    else {
				...
				<div class="navbar navbar-inverse navbar-static-top" role="navigation">
					...
					<div class="navbar-collapse collapse">
						<ul class="nav navbar-nav">
							...
							<?php $myWebsite='http://localhost:80'; if($myWebsite!='') { echo '<li><a class="navbar-brand" target="" href="javascript:extractHostname()">' . tr('My Website') . '</a></li>'; } ?>
							...
							<li<?php if (strpos('apc eaccelerator xcache phpmyadmin sqlitemanager phpliteadmin', $page) !== false) { ?> class="active dropdown"<?php } else { ?> class="dropdown" <?php } ?>>
								...
								<ul class="dropdown-menu">
                                    ...
                                    <?php else: ?>
                                        <li class="disabled"><a href="#">phpMyAdmin (<?php echo tr("needs at least PHP 5.5"); ?>)</a></li>
                                        <?php endif; ?>
                
									<li<?php if($page=="phpliteadmin") { ?> class="active"<?php } ?>><a target="_blank" href="<?php echo "/phpLiteAdmin/"; ?>">phpLiteAdmin</a></li>								
			...
			<div class="row">
				<div class="col-lg-6">
					<div class="frame">
						...
						<p>
						<?php if(version_compare(PHP_VERSION, '5.5.0', '>=')): ?>
							<?php printf(tr('MySQL can be administered with %sphpMyAdmin%s.'), a('phpmyadmin'),'</a>'); ?>
						<?php else: ?>
...
<?php } ?>                                                    
			...
			<footer style="margin-top:40px;">
				...
				<p>&copy; 2013 - 2016 <a href="http://www.appsolute.de">appsolute GmbH</a></p>
			</footer>
		</div><!-- /.container -->
